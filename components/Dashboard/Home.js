            ...
            <Block row card shadow color='#FFFFFD' style={styles.request}>
                ...
                <Block flex={0.8} column middle>
                    <Block row space='between'>
                        <Text h3 style={{ paddingTop: 0, paddingBottom: 8 }}>{request.title}</Text>
                        <ThemeProvider theme={custom}>
                            <Badge status={this.selectPriorityColor(request.priority)} badgeStyle={{ width: 10, height: 10, borderRadius: 10 / 2 }} />
                        </ThemeProvider>
                    </Block>
                    <Text caption lightText>{request.description}</Text>
                </Block>
            </Block>
        )
    }
