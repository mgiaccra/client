...
class Home extends Component {
    ...
    gotoAddTicketScreen = () => {
        console.log('Goto Add Ticket Screen')
        ...
        return (
            <Block flex={0.5} column style={{ paddingHorizontal: 15 }}>
                <Block flex={false} row style={{ paddingVertical: 15, marginTop: 15 }}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} onPress={this.gotoProfileScreen}>
                        <Image style={styles.userAvatar} source={{ uri: user.avatar }} />
                    </TouchableOpacity>
                </Block>
                <Block card shadow color='#FFFFFD' style={styles.headerChart}>
    ...
    renderRequests() {
        ...
        return (
            <Block flex={0.8} column color='light' style={styles.requests}>
                ...
                {this.renderFloatingActionBtn()}
            </Block>
        )
    }

    renderFloatingActionBtn() {
        return (
            <TouchableOpacity activeOpacity={0.4} onPress={this.gotoAddTicketScreen} style={styles.fab}>
                {/* <Text style={styles.fabIcon}>+</Text> */}
                <Icon name='plus' size={20} type='font-awesome' color='#fff' />
            </TouchableOpacity>
        )
    }
